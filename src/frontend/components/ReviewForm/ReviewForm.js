...
export default class SignupForm extends React.Component{
    ...
    handleSubmit = async(event)=>{
        ...
        const payload = {userId : userId, hotelId : this.props.hotelId, title : this.state.title, description : this.state.description, rating : this.state.rating}
        
        await api.insertReview(payload).then((review)=>{
            this.props.handleClose()
            this.props.displayReviews()
        })
    }
}